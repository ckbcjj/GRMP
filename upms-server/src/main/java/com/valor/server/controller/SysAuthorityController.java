...
import com.valor.server.service.SysAuthoritiesService;
...
@Controller
@RequestMapping(value = "/api/upms/sysAuthority")
public class SysAuthorityController {
    ...
    @ResponseBody
    public UpmsResponse<PageResultResponse<SysAuthorityResponse>> query(HttpServletRequest request, HttpServletResponse response, @RequestBody SysAuthorityRequest args) throws APIException {
        ...
        return new UpmsResponse(authoritiesService.query(args));
    }

    @UpmsApiCall
    @UpmsLogCall
    @RequestMapping(value = "getAuths/v1", method = {RequestMethod.POST})
    @ResponseBody
    public UpmsResponse<PageResultResponse<SysAuthorityResponse>> getAuths(HttpServletRequest request, HttpServletResponse response, @RequestBody SysRoleAuthRequest args) throws APIException {
        if (args.getRequestType() != RequestType.QUERY) {
            throw new APIException(UpmsHttpCode.RET_QUERY, UpmsHttpCode.ERR_INVALID_ARGS, UpmsHttpCode.ERR_INVALID_ARGS_MSG);
        }
        ...
        return new UpmsResponse(authoritiesService.getAuths(args));
    }
    ...
    @ResponseBody
    public UpmsResponse<Boolean> update(HttpServletRequest request, HttpServletResponse response, @RequestBody SysAuthorityRequest args) throws APIException {
        if (args.getRequestType() != RequestType.CREATE && args.getRequestType() != RequestType.UPDATE) {
            throw new APIException(UpmsHttpCode.RET_QUERY, UpmsHttpCode.ERR_INVALID_ARGS, UpmsHttpCode.ERR_INVALID_ARGS_MSG);
        }
        return new UpmsResponse(authoritiesService.update(args));
    }
    ...
    @ResponseBody
    public UpmsResponse<Boolean> delete(HttpServletRequest request, HttpServletResponse response, @RequestBody SysAuthorityRequest args) throws APIException {
        ...
        return new UpmsResponse(authoritiesService.delete(args));
    }
}
